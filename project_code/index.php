...
<head>
    ...
    <style>
        ...
        * {  
        ...
        body {
            background: url("https://t3.ftcdn.net/jpg/03/03/56/26/360_F_303562626_1AZJl5l3dusA2R1pSDNXnoTYYNDO73Jy.jpg");
    ...
    min-height: auto; /* Match this with the nav height */
        ...
        .nav-logo img {
			padding-top:10px;
    height: 180px; /* Adjust this value to fit your logo */
    width: auto;
	text-align:center;
...
<body>
 <div class="wrapper">
    ...
    <img src="image/logo1.png" alt="Bank LMS Logo">
        ...
        <div class="nav-menu" id="navMenu" style="color:green;font-size:55px;font-weight: 500;">
		 APCOB Learning Management System
        </div>
    ...
    <div class="form-box">
        ...
        <div class="login-container" id="login">
            <header>Login to LMS</header>
            <form action="login.php?q=about.php" method="POST" onsubmit="return validateLoginForm()">
                <div class="input-box">
                    <input type="text" class="input-field" placeholder="Employee ID" id="employeeId" name="employeeId" autocomplete="off">
