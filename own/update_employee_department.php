    ...
    <table>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><button onclick=\"window.location.href='edit_employee_department.php?sl_no=" . $row['sl_no'] . "'\">Edit</button></td>";
                echo "<td><button class='delete-button' onclick=\"window.location.href='delete_employee_department.php?sl_no=" . $row['sl_no'] . "'\">Delete</button></td>";
                echo "</tr>";
            }
        } else {
