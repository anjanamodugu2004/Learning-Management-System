...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO employee_branch (emp_id, emp_name, designation, mailid, contact_no,branch_name) VALUES ('$emp_id', '$emp_name', '$designation', '$mailid', '$contact_no','$branch_name')";
...
<body>
    ...
    <form method="post" action="insert_employee_branch.php">
